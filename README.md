...
After conducting our permutation test, we calculated a p-value of 0.11, which is greater than the significance value of 0.05 so we conclude that it is likely that the missingness of 'rating' does not depend on 'n_ingredients'. 
...
Since the p-value is less than the significance level of 0.05, we conclude it is likely that the missingness of 'rating' does depend on the column 'n_steps'. 
